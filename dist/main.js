...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.signin = function (user) {
        this.server.loginUser(this.user).then(function (response) {
            console.log(response);
        }).catch(function (error) {
            console.log(error);
        });
...
var ServerProvider = /** @class */ (function () {
    ...
    // Login
    ServerProvider.prototype.loginUser = function (user) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
    ...
    ;
    // type problem
    ServerProvider.prototype.likeDemand = function (demand, idToken) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]({
            'Content-Type': 'application/json'
        });
        var options = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["RequestOptions"]({ headers: headers });
    ...
    ;
    //demands
    ServerProvider.prototype.getAllDemands = function (page) {
    };
